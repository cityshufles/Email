...
namespace Email.Services.Community
{
    public interface ICommunityService
    {
        ...
        Task<int> CreatePostAsync(CommunityPostWriteModel post, CancellationToken ct = default);
        ...
        Task SendAnnouncementEmailsAsync(int postId, CancellationToken ct = default);
    }
}
